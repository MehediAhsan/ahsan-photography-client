                ...
                <div class="grid grid-cols-1 md:grid-cols-2">
                    ...
                    <form class="p-6 flex flex-col justify-center">
                        ...
                        <div class="flex flex-col mt-2">
                            ...
                            <input type="tel" name="tel" id="tel" placeholder="Telephone Number" class="w-100 mt-2 py-3 px-3 rounded-lg bg-white border border-gray-400 dark:border-gray-700 text-gray-800 font-semibold focus:border-indigo-500 focus:outline-none"/>
                        </div>

                        <button type="submit" class="md:w-32 bg-orange-500 hover:bg-blue-dark text-white font-bold py-2 px-3 rounded-lg mt-3 hover:bg-orange-600 transition ease-in-out duration-300">
                            Submit
                        </button>
                    </form>
                </div>
