...
const Blog = () => {
    return (
        <section className=" my-10 dark:text-gray-700">
	<div className="container max-w-6xl p-6 mx-auto space-y-6 sm:space-y-12">
		...
		<div className="flex justify-center">
			<button type="button" className="px-4 py-2 text-sm rounded-md hover:underline  dark:text-gray-100 bg-gray-600">Load more posts...</button>
		</div>
	</div>
</section>
    );
